...
import cococo.snake_builder as snake_builder
import csv
import numpy as np
import stim
...
def test_snake_builder_stdw():
    ...
    hx_desired = []
    with open("test/python/hx_desired_stdw.csv") as f:
        reader = csv.reader(f)
        for row in reader:
            hx_desired.append([int(x) for x in row])

    hz_desired = []
    with open("test/python/hz_desired_stdw.csv") as f:
        reader = csv.reader(f)
        for row in reader:
...
def test_snake_builder():
    ...
    aim_x_check = []
    with open("test/python/hx_desired_steane.csv") as f:
        reader = csv.reader(f)
        for row in reader:
            aim_x_check.append([int(x) for x in row])

    aim_z_check = []
    with open("test/python/hz_desired_steane.csv") as f:
        reader = csv.reader(f)
        for row in reader:
